...
import io.swagger.client.model.LawSearch;
...
public class InlineResponse20010 {
  ...
  private List<LawSearch> results = new ArrayList<LawSearch>();
  ...
  **/
  ...
  public InlineResponse20010 next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20010 previous(String previous) {
  ...
  **/
  ...
  public InlineResponse20010 results(List<LawSearch> results) {
    this.results = results;
    return this;
  }

  public InlineResponse20010 addResultsItem(LawSearch resultsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "")
  public List<LawSearch> getResults() {
    return results;
  }

  public void setResults(List<LawSearch> results) {
    this.results = results;
  }
