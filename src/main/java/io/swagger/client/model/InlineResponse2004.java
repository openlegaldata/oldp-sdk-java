...
import io.swagger.client.model.CaseSearch;
...
public class InlineResponse2004 {
  ...
  private List<CaseSearch> results = new ArrayList<CaseSearch>();
  ...
  **/
  ...
  public InlineResponse2004 results(List<CaseSearch> results) {
    this.results = results;
    return this;
  }

  public InlineResponse2004 addResultsItem(CaseSearch resultsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "")
  public List<CaseSearch> getResults() {
    return results;
  }

  public void setResults(List<CaseSearch> results) {
    this.results = results;
  }
