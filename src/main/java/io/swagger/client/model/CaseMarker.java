...
public class CaseMarker {
  ...
  **/
  ...
  public CaseMarker belongsTo(Integer belongsTo) {
  ...
  **/
  ...
  public CaseMarker label(Integer label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public CaseMarker valueStr(String valueStr) {
  ...
  **/
  ...
  public CaseMarker valueInt(Integer valueInt) {
  ...
  **/
  ...
  public CaseMarker start(Integer start) {
    this.start = start;
    return this;
  }
   ...
   * @return start
  **/
  @ApiModelProperty(value = "Start position of marker (from 0)")
  ...
  public CaseMarker end(Integer end) {
    this.end = end;
    return this;
  }
   ...
   * @return end
  **/
  @ApiModelProperty(value = "End position of marker")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CaseMarker caseMarker = (CaseMarker) o;
    return Objects.equals(this.id, caseMarker.id) &&
        Objects.equals(this.belongsTo, caseMarker.belongsTo) &&
        Objects.equals(this.label, caseMarker.label) &&
        Objects.equals(this.valueStr, caseMarker.valueStr) &&
        Objects.equals(this.valueInt, caseMarker.valueInt) &&
        Objects.equals(this.createdAt, caseMarker.createdAt) &&
        Objects.equals(this.updatedAt, caseMarker.updatedAt) &&
        Objects.equals(this.start, caseMarker.start) &&
        Objects.equals(this.end, caseMarker.end);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, belongsTo, label, valueStr, valueInt, createdAt, updatedAt, start, end);
  }
