...
public class InlineResponse2001 {
  ...
  private List<CaseAnnotation> results = new ArrayList<CaseAnnotation>();
  ...
  **/
  ...
  public InlineResponse2001 results(List<CaseAnnotation> results) {
    this.results = results;
    return this;
  }

  public InlineResponse2001 addResultsItem(CaseAnnotation resultsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "")
  public List<CaseAnnotation> getResults() {
    return results;
  }

  public void setResults(List<CaseAnnotation> results) {
    this.results = results;
  }
