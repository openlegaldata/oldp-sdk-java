...
/**
 * API tests for CourtsApi
 */
@Ignore
public class CourtsApiTest {

    private final CourtsApi api = new CourtsApi();
     ...
     */
    @Test
    public void courtsListTest() throws ApiException {
        ...
        Integer limit = null;
        Integer offset = null;
        InlineResponse2007 response = api.courtsList(courtType, slug, code, stateId, cityId, limit, offset);
     ...
     */
    @Test
    public void courtsReadTest() throws ApiException {
        Integer id = null;
        Court response = api.courtsRead(id);
